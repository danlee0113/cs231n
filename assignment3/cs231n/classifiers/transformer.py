...
class CaptioningTransformer(nn.Module):
    ...
    def __init__(self, word_to_idx, input_dim, wordvec_dim, num_heads=4,
        ...
        self.visual_projection = nn.Linear(input_dim, wordvec_dim) #features into wordvec.
    ...
    def forward(self, features, captions):
        """
        Given image features and caption tokens, return a distributfn over the
        ...
        caption_embed=self.embedding(captions) # shape (25,16,256)
