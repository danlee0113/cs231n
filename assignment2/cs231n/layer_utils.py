...
def affine_batchnorm_backward(dout,cache):
   ...
   da=relu_backward(dout,relu_cache)
   dbn,dgamma,dbeta=batchnorm_backward_alt(da,batch_cache)
...
def affine_layernorm_forward(x,w,b,gamma,beta,bn_param):
  a, fc_cache = affine_forward(x, w, b)
  ln,layer_cache= layernorm_forward(a,gamma,beta,bn_param)
...
def affine_layernorm_backward(dout,cache):
  ...
  da=relu_backward(dout,relu_cache)
  dln,dgamma,dbeta=layernorm_backward(da,layer_cache)
